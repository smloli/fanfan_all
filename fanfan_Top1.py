...
class Novel:
    ...
    def __init__(self):
        ...
        self.root = 'https://bbs.fanfanf.com/'
        # 判断Novel文件夹是否存在，不存在就创建
        self.path = '/home/fanfan/novel/'
        self.error = '/home/fanfan/error.log'
    ...
    def get_html(self, url):
        try:
            ...
            with open(self.error, 'a', encoding='utf-8') as f:
                f.write(f'{error}\n')
            return

    def get_xpath(self):
        #url = self.root + thread.php?fid=117&type=49&page=1'
        ...
        # for page in range(1):
            try:
                ...
                # page += 1
                page = 1
                url = self.root + 'thread.php?fid=117&type=49&page=' + str(page)
                html = self.get_html(url)
